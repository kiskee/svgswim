  ...
  */
  ...
  return (
    <div className="justify-center h-[calc(100vh-4rem)] flex items-center text-center text-white">
      <form onSubmit={handleSubmit} className="bg-neutral-950 px-8 py-10 w-3/12 rounded-lg border-2 border-blue-600 shadow-2xl shadow-purple-400">
        {error && <div className="bg-red-500 text-white p-2 mb-2">{error}</div>}
        <h1 className="text-4xl font-bold mb-7">User Register</h1>

        <label className="text-slate-300">Fullname:</label>
        <input type="text"  className="mt-1 block text-slate-400 w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
      ...
      />
        ...
        <Link href="/login" className="bg-green-500 text-white px-4 py-2 block w-full mt-4">Login</Link>
